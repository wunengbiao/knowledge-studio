...
const fr: Record<keyof typeof zh, string> = {
  ...
  'chat.citationsPanelToggle': 'Liste des citations',
  'chat.citationsPanelTitle': 'Citations',
  'chat.citationsPanelClose': 'Fermer la liste des citations',
  'chat.citationsPanelEmpty': 'Aucune citation pour le moment',
  'chat.send': 'Envoyer',
  'chat.stop': 'Arrêter',
